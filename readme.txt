...
Generate one using tools like GnuPG (`gpg --gen-key`) or services like ProtonMail, then export it in armored format (`gpg --armor --export your-email dot com`) and paste it into the plugin’s admin settings.
